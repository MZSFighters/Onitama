...
class Game:
    ...
    def game_loop(self):
        ...
        while self.playing:
            ...
            if player.colour == True:
                self.draw_card(self.display, self.neutralCardName, 800, 350)
                self.draw_card(self.display, self.p_firstCardName, 800, 150)
                self.draw_card(self.display, self.p_secondCardName, 1050, 150)
                self.draw_card(self.display, self.opp_firstCardName, 800, 550)
                self.draw_card(self.display, self.opp_secondCardName, 1050, 550)
            else:
                self.draw_card(self.display, self.neutralCardName, 800, 350)
                self.draw_card(self.display, self.opp_firstCardName, 800, 150)
                self.draw_card(self.display, self.opp_secondCardName, 1050, 150)
                self.draw_card(self.display, self.p_firstCardName, 800, 550)
                self.draw_card(self.display, self.p_secondCardName, 1050, 550)
    ...
    def draw_card(self, display, cardName, x, y):
        ...
        self.draw_text(cardName, 25, x + card_width / 2, y+card_height/2, WHITE, "center")
    ...
    def highlightCardSelected(self,player, cardNum):
        ...
        if player.colour == True:
            ...
            if cardNum == 0:
                pygame.draw.rect(self.display, RED, (800,150,card_width+outline, card_height+outline))
                self.window.blit(self.display, (0,0))
            elif cardNum == 1:
                pygame.draw.rect(self.display, RED, (1050,150,card_width+outline, card_height+outline))
                self.window.blit(self.display, (0,0))

        else:

            if cardNum == 0:
                pygame.draw.rect(self.display, BLUE, (800,550,card_width+outline, card_height+outline))
                self.window.blit(self.display, (0,0))
            elif cardNum == 1:
                pygame.draw.rect(self.display, BLUE, (1050,550,card_width+outline, card_height+outline))
                self.window.blit(self.display, (0,0))
